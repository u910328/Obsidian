(function() {
    ...
    angular
        .module('obsidian.themes')
        .provider('obSkins', skinsProvider)
        .run(addSkinToScope);

    /* @ngInject */
    function skinsProvider($mdThemingProvider, obThemingProvider) {
        var skins = {};
        ...
        return {
            skin: function(id, name) {
                ...
                var skin = new Skin(id, name, $mdThemingProvider, obThemingProvider);
            ...
            setSkin: function(id) {
                ...
                if(useSkinCookie) {
                    ...
                    var obsidianSkin = $cookies.get('obsidian-skin');
                    if(angular.isDefined(obsidianSkin)) {
                        var cookieTheme = angular.fromJson(obsidianSkin);
    ...
    /* @ngInject */
    function Skin(id, name, $mdThemingProvider, obThemingProvider) {
        ...
        self.loadThemes = function() {
            ...
            for (var element in self.elements) {
                ...
                var theme = obThemingProvider.theme(self.elements[element]);
    ...
    /* @ngInject */
    function addSkinToScope($rootScope, obSkins) {
        $rootScope.obSkin = obSkins.getCurrent();
    }
})();